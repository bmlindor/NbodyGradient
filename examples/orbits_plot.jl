# examples
include("../src/VisualizeNbodyGradient.jl")
 #Example for Kepler-16 with additional planet orbiting star B:
    ...
    nsteps=340
    kep=Keplerians(intr,ic,nsteps;names=["A","B","Bb","ABb"]) # nsteps to visualize
    # r=Keplerians(ic,t0,tmax,h;names=["A","B","Bb","ABb"])  
    # make_plot(r)
    animate_plot(kep,save=true,filename="example.mp4")